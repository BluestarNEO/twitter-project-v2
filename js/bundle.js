...
},{"./template.js":2,"jquery":12}],2:[function(require,module,exports){
'use strict';
...
},{"./../templates/compose.handlebars":13,"./../templates/thread.handlebars":14,"./../templates/tweet.handlebars":15,"hbsfy/runtime":11}],3:[function(require,module,exports){
'use strict';
...
},{"./handlebars/base":4,"./handlebars/exception":5,"./handlebars/no-conflict":6,"./handlebars/runtime":7,"./handlebars/safe-string":8,"./handlebars/utils":9}],4:[function(require,module,exports){
'use strict';
...
/* [args, ]options */
},{"./exception":5,"./utils":9}],5:[function(require,module,exports){
'use strict';
...
},{"./base":4,"./exception":5,"./utils":9}],8:[function(require,module,exports){
'use strict';
...
},{"./dist/cjs/handlebars.runtime":3}],11:[function(require,module,exports){
...
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
    return "<form class=\"compose\">\n    <textarea placeholder=\"Compose new tweet...\"></textarea>\n    <div>\n        <span class=\"count\">140</span>\n        <button>Send</button>\n    </div>\n</form> ";
},"useData":true});

},{"hbsfy/runtime":11}],14:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  ...
  return "<div class=\"thread\">\n    "
    ...
    + "\n    <div class=\"replies\">\n        "
    + ((stack1 = ((helper = (helper = helpers.compose || (depth0 != null ? depth0.compose : depth0)) != null ? helper : alias1),(typeof helper === alias2 ? helper.call(depth0,{"name":"compose","hash":{},"data":data}) : helper))) != null ? stack1 : "")
    + "\n    </div>\n</div>";
},"useData":true});

},{"hbsfy/runtime":11}],15:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
